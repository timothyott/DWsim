...
def main(P,D,kw,kb,i):    
    # *** MODEL INPUTS ***

    # SYSTEM INPUT
    i = i  # number of landscapes to produce (use 100 or less for testing)
    ...
    print("Generating "+str(P)+"x"+str(D)+", kw="+str(kw)+", kb="+str(kb))
